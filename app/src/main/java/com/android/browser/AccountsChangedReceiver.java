...
public class AccountsChangedReceiver extends BroadcastReceiver {
    ...
    private static final String SELECTION = BrowserContract.Accounts.ACCOUNT_NAME + " IS NOT NULL";
    private static final String DELETE_SELECTION = BrowserContract.Accounts.ACCOUNT_NAME + "=? AND "
            + BrowserContract.Accounts.ACCOUNT_TYPE + "=?";
    ...
    static class DeleteRemovedAccounts extends Thread {
        ...
        public void run() {
            ...
            Cursor c = cr.query(BrowserContract.Accounts.CONTENT_URI, PROJECTION,
                    SELECTION, null, null);
            while (c.moveToNext()) {
        ...
        void delete(ContentResolver cr, String name, String type) {
            ...
            // is added back.
            Uri uri = BrowserContract.Bookmarks.CONTENT_URI.buildUpon()
