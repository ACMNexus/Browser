...
public class ScrollerView extends FrameLayout {
    ...
    /**
     * TCL ADD:
     * StrictMode.enterCriticalSpanc is hide.
     *
     */
                ...
                if (!mIsBeingDragged) {
                    if (mHorizontal) {
                        ...
                        if (hscroll != 0) {
                        	...
                        	// getHorizontalScrollFactor is hide in View.
                        	// While getHorizontalScrollFactor calls getVerticalScrollFactor.
                        	final int delta = (int) (hscroll * getVerticalScrollFactor());
                            final int range = getScrollRange();
